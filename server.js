...
http.listen(3000, function () {
	...
	mongoClient.connect("mongodb+srv://root:root@cluster0.jwrqjyh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", { useUnifiedTopology: true }, function (error, client) {
		if (error) {
			console.log(error);
			return;
		}
